if !get(g:, 'loaded_gutentags', v:false)
  finish
endif
...
let g:gutentags_cache_dir = expand('$DATAPATH/tags')
...
let g:gutentags_project_root = [".vimrc", ".vimrc.lua ", ".vscode", ".vim/settings.vim"]
...
let g:gutentags_scopefile = '$DATAPATH/tags/cscope.big'
