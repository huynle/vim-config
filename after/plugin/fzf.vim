" if !get(g:, 'loaded_fzf', v:false) && has("nvim")
"   finish
" endif
if v:true
  finish
...
nnoremap <silent><leader>fb :<C-u>Buffer<CR>
nnoremap <silent><leader>ft :<C-u>Tags<CR>
nnoremap <silent><leader>ff :<C-u>Lines<CR>
...
nnoremap <silent><leader>hk :<C-u>Maps<CR>
