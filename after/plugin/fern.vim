...
function! s:init_fern()
	...
	nmap <buffer><silent> H      <Plug>(fern-action-hide-toggle)
	...
	nmap <buffer><silent> a      <Plug>(fern-action-new-path)
	nmap <buffer><silent> e      <Plug>(fern-action-open)
	" nmap <buffer><silent> <CR>   <Plug>(fern-action-open-or-enter)
	nmap <buffer><silent> <CR>   <Plug>(fern-my-open-or-expand)
	...
	nmap <buffer><silent> <c-v>     <Plug>(fern-action-open:right)
	nmap <buffer><silent> <c-s>     <Plug>(fern-action-open:below)
